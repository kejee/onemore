...
-(void)prepareLayout{
    ...
    CGFloat collectionH = CGRectGetHeight(self.collectionView.frame);
    
    self.itemSize = CGSizeMake(collectionW-80, 200);
    self.collectionView.pagingEnabled = YES;
    if (self.isHorizontal) {
        /// collectionView 的 宽度 去掉 item 宽度
        CGFloat contentInset = collectionW - self.itemSize.width;
        ...
        /// collectionView 的 宽度 去掉 item 宽度
        CGFloat contentInset = collectionH - self.itemSize.height;
